        ...
        <div class="main px-5">
            ...
            <main>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <figure>
                            <img class="img-fluid px-5 py-5" src="images/product_images/<?= $result["img"] ?>"
                                 alt="<?= $result["name"] ?>">
                        </figure>
                    </div>
                    <div class="col-md-6 px-5 py-5">
                        ...
                        <div class="fs-6 my-3 text-danger fw-bold">
                            庫存：<?php if ($result["stock_num"] >= 0) {
                                echo $result["stock_num"];
                            } else echo "0" ?>
                        </div> <!--庫存檢查-->

                        <form action="cartAddCart.php" method="get"><!--計算數量加入購物車-->
                            <input name="num" type="text" class="num form-control" value="1">
                            <input name="id" hidden type="text" class="num form-control" value="<?= $result["id"] ?>">
                            <button type="submit" class="btn btn-mao-primary"">加入購物車</button>
                        </form>
