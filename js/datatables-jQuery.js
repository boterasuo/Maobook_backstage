        ...
        1: [function (t, e, s) {
                    ...
                    var i = e((function (t, e) {
                        t.exports = function () {
                                ...
                                g = {
                                    ...
                                    s: m, z: function (t) {
                                        ...
                                        var i = 12 * (s.year() - e.year()) + (s.month() - e.month()),
                                            a = e.clone().add(i, h), n = s - a < 0, r = e.clone().add(i + (n ? -1 : 1), h);
                            ...
                            var $ = function () {
                                ...
                                return m.parse = function (t) {
                                    ...
                                    }, g = this.$W, m = this.$M, b = this.$D, y = "set" + (this.$u ? "UTC" : "");
                                    switch (u) {
                                        case d:
                                        ...
                                        case o:
                                            var v = this.$locale().weekStart || 0, w = (g < v ? g + 7 : g) - v;
                                    ...
                                    var p, f = M.p(c), g = x(s), m = (g.utcOffset() - this.utcOffset()) * t,
                                        b = this - g, y = M.m(this, g);
                                    return y = (p = {}, p[d] = y / 12, p[h] = y, p[l] = y / 3, p[o] = (b - m) / 6048e5, p[r] = (b - m) / 864e5, p[n] = b / e, p[a] = b / t, p[i] = b / 1e3, p)[f] || b, u ? y : M.a(y)
                        ...
                        t.exports = function () {
                            var t = {
                                ...
                                s = /\d\d/, i = /\d\d?/, a = /\d*[^\s\d-_:/()]+/, n = {}, r = function (t) {
                                ...
                                return function (t) {
                                    for (var e = {}, s = 0, i = 0; s < o; s += 1) {
                                        ...
                                        if ("string" == typeof a) i += a.length; else {
                                            var n = a.regex, h = a.parser, l = t.substr(i), d = n.exec(l)[0];
                                    ...
                                    if ("string" == typeof o) {
                                        ...
                                        l && (c = r[2]), n = this.$locale(), !h && c && (n = s.Ls[c]), this.$d = function (t, e, s) {
                                            try {
                                                ...
                                                var b = o || 0, y = h || 0, v = l || 0, w = d || 0;
                                                return c ? new Date(Date.UTC(g, m, f, b, y, v, w + 60 * c.offset * 1e3)) : s ? new Date(Date.UTC(g, m, f, b, y, v, w)) : new Date(g, m, f, b, y, v, w)
                                            } catch (t) {
                                                return new Date("")
                                            }
            ...
            const d = function (t) {
                ...
                labels: {
                    ...
                    perPage: "顯示 {select} 筆",
                    noRows: "無法查詢到任何資料",
                    noResults: "沒有符合條件的搜尋結果",
                    info: "顯示 {start}~{end}，共{rows}筆資料"
                },
                    ...
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.dom.tHead) {
                            if (this.options.scrollY.length && (e = a("thead"), e.appendChild(a("tr")), e.style.height = "0px", this.headerTable && (this.dom.tHead = this.headerTable.tHead)), this.activeHeadings.forEach((t => {
                                ...
                                const i = t.offsetWidth, n = i / this.rect.width * 100;
